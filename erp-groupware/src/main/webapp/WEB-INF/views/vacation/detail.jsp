                        ...
                        <form action="#"  method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <input type="checkbox" name="appro" value="approBos1" onClick="return false">
                                            ${vacationApplyVO.approBos1 }</td>
                                            <td><input type="checkbox" name="appro" value="approBos2" onClick="return false">
                                            ${vacationApplyVO.approBos2 }</td>
                                            <td><input type="checkbox" name="appro" value="approBos3" onClick="return false">
                                            ${vacationApplyVO.approBos3 }</td>
                                            <td>${vacationApplyVO.approYN }</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row flex-box">
                                <div>
                                    <div class="row">
                                        <label>사원명</label>
                                        <input type="text" class="filed form" value="${vacationApplyVO.name }" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div>
                                    ...
                                    value="${vacationApplyVO.approNo2 }" readonly>
                                </div>
                                <div>
                                    <label>직급</label>
                                    <input type="text" class="filed form" value="${vacationApplyVO.levelCd }" readonly>
                                </div>
                                <div>
                                    <label>부서</label>
                                    <input type="text" class="filed form" value="${vacationApplyVO.deptCd }" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div>
                                    <label>EMAIL</label>
                                    <input type="text" class="form" value="${vacationApplyVO.empEmail }" readonly>
                                </div>
                                <div>
                                    <label>휴대폰 번호</label>
                                    <input type="number" class="form" value="${vacationApplyVO.vacaTel }" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row flex-box">
                                <div class="w-50">
                                    ...
                                    value="${vacationApplyVO.vacaSdate }" readonly>
                                </div>
                                <div class="w-50">
                                    <label>휴가 종료일</label>
                                    <input type="text" class="field w-100 test7-2 form"
                                    value="${vacationApplyVO.vacaEdate }" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div>
                                    <label>휴가 종류</label>
                                    <input type="text" class="filed form" value="${vacationApplyVO.vacaType }" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row flex-box" style="position: relative;">
                                <div>
                                    <label>휴가 사유</label>
                                    <textarea class="field w-100 form" rows="3" style="padding-right: 100px;"  readonly
                                    				>${vacationApplyVO.vacaReason }</textarea>
                                    <a href="/vacation/list">뒤로가기</a>
                                    <a href="/vacation/edit?vacaNo=${vacationApplyVO.vacaNo }">승인하기</a>
                                    <a href="insert">글쓰기</a>
                                </div>
	                 		</form>
                            </div>
