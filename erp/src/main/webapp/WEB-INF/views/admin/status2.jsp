...
$(function(){
    createChart("${pageContext.request.contextPath}/rest/emp/status/hi",".emp-new-chart","입사자 수", "bar");
    createChart("${pageContext.request.contextPath}/rest/emp/status/bye",".emp-bye-chart","퇴사자 수", "bar");
});
</script>
