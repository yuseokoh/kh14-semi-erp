...
.form1 label .input1:focus+span, .form1 label .input1:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .select1:focus+span, .form1 label .input1:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .join1:focus+span, .form1 label .input1:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .birthday1:focus+span, .form1 label .input1:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .address:focus+span, .form1 label .address:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .address1:focus+span, .form1 label .address1:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
.form1 label .address2:focus+span, .form1 label .address2:valid+span {
	color: antiquewhite;
	top: 0px;
	font-size: 0.7em;
	font-weight: 600;
...
<div class="container">
	<form class="form" action="login" method="post">
		...
		<input placeholder="Username" class="username input" type="text" name="loginId"> <input placeholder="Password" class="password input" type="password" name="password"> <span class="span"><a href="findPw">Forgot password?</a></span>
	...
	<form class="form1" action="join" method="post">
		...
		<label> <input class="input1" type="text" name="loginId" placeholder="" required="">
		<span class="span1">아이디</span>
		</label> <label> <input class="input1" type="password" name="password" placeholder="" required="">
		<span class="span1">비밀번호</span>
		</label> <label> <input class="input1" type="password" id="password-check" placeholder="" required="">
		<span class="span1">비밀번호 확인</span>
		</label>

		<div class="flex1">
			<label> <input class="input1" name="name" type="text" placeholder="" required="">
