		...
		<main id="body">
			...
			<div class="row flex-box w-1200">
				...
				<div class="w-70 center"
					style="max-width: 100%; overflow-x: hidden; overflow-y: auto; height: 589px;">
					<table style="width: 100%; border-collapse: collapse;" class="tb">
						<thead>
							<tr>
								<th
									style="border: 1px solid #ddd; padding: 8px; text-align: left;">작성일</th>
								<th
									style="border: 1px solid #ddd; padding: 8px; text-align: left;">제목</th>
								<th
									style="border: 1px solid #ddd; padding: 8px; text-align: left;">작성자</th>
								<th
									style="border: 1px solid #ddd; padding: 8px; text-align: left;">조회수</th>
							</tr>
						</thead>
						<tbody class="tbody">
							<c:forEach var="notice" items="${noticeList}">
								<tr class="row center">
									<td
										style="border: 1px solid #ddd; padding: 8px; text-align: left; white-space: nowrap;">${notice.noticeWtime}</td>
									<td class="name"
										style="border: 1px solid #ddd; padding: 8px; text-align: left; white-space: nowrap;">${notice.noticeTitle}</td>
									<td
										style="border: 1px solid #ddd; padding: 8px; text-align: left; white-space: nowrap;">${notice.noticeWriter}</td>
									<td
										style="border: 1px solid #ddd; padding: 8px; text-align: left; white-space: nowrap;">${notice.noticeViews}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
