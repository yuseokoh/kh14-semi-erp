            ...
            $('.btn-positive').on(
                ...
                function() {
                    ...
                    $('.btn-warning').on('click', function() {
                        ...
                        //비동기통신해서 내용만 바꾸기
                        $.ajax({
                            url: '${pageContext.request.contextPath}/rest/vacation/update', // 요청할 URL
                            ...
                            success: function(response) { // 요청이 성공했을 때 호출되는 함수
                                if (response) {
                                    ...
                                    Swal.fire({
                                        ...
                                        willClose: () => {
                                            location.href = '${pageContext.request.contextPath}/vacation/mylist?loginId=${sessionScope.createdUser}';
                                        },
                                        customClass: {
                                            title: 'custom-title',
                                            popup: 'custom-background',
                    ...
                    <div class="container w-900">
                        ...
                        <div class="table-container">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="${pageContext.request.contextPath}/vacation/signImage?approNo=${tbEmpVacaReqDto.approNo}&applicantId=${tbEmpVacaReqDto.applicantId}"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
