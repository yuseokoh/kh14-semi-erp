    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.write').on('click', function() {
                // 확인 대화상자 표시
                window.location.href = '${pageContext.request.contextPath}/vacation/insert'; // 여기에 원하는 링크를 입력하세요
            });
        });
    </script>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <c:forEach var="TbEmpVacaReqDto" items="${list}">
                                                ...
                                                <td><a class="name" href="${pageContext.request.contextPath}/vacation/detail?vacaNo=${TbEmpVacaReqDto.vacaNo}">${TbEmpVacaReqDto.vacaTitle}</a></td>
