								...
								onImageUpload : function(files) {
									...
									$
											.ajax({
												...
												url : "${pageContext.request.contextPath}/rest/notice/upload",
												method : "post",
												data : form,
												success : function(response) {
													var tag = $("<img>").attr(
															"src",
															"${pageContext.request.contextPath}/attach/download?documentNo="
																	+ response);
													$("[name=noticeCont]")
															.summernote(
																	"insertNode",
					...
					<form action="noticInsert" method="post" autocomplete="off">
						<div class="container w-900">
							...
							<div class="row flex-box" style="margin-top: 20px;">
								<div>
									<label>제목</label> <input type="text" class="form title1"
										name="noticeTitle">
								</div>
							</div>
							...
							<div class="row flex-box"
								...
								<div>
									...
									<textarea class="field w-100 form " rows="3"
										style="padding-right: 100px;" name="noticeCont"></textarea>
								</div>
