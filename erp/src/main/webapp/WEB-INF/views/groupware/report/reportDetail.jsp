                ...
                function() {
                    ...
                    $('.btn-warning').on(
                        ...
                        function() {
                            ...
                            $.ajax({
                                url: '${pageContext.request.contextPath}/rest/report/update', // 요청할 URL
                                ...
                                success: function(response) { // 요청이 성공했을 때 호출되는 함수
                                    if (response) {
                                        ...
                                        Swal.fire({
                                            ...
                                            willClose: () => {
                                                location.href = '${pageContext.request.contextPath}/report/mylist?loginId=${sessionScope.createdUser}';
                                            },
                                            customClass: {
                                                title: 'custom-title',
                                                popup: 'custom-background',
                ...
                <div class="container w-900">
                    ...
                    <div class="table-container">
                        <table class="table form">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="${pageContext.request.contextPath}/report/signImage?approNo=${tbEmpReportDto.approNo}&writerId=${tbEmpReportDto.writerId}"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
