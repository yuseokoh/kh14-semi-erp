    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.write').on('click', function() {
                // 확인 대화상자 표시
                window.location.href = '${pageContext.request.contextPath}/report/insert'; // 여기에 원하는 링크를 입력하세요
            });
        });
    </script>
                                        ...
                                        <c:otherwise>
                                            <c:forEach var="TbReportRecVO" items="${list}">
                                                <tr class="row center">
                                                    ...
                                                    <td><a class="name" href="${pageContext.request.contextPath}/report/detail?reportNo=${TbReportRecVO.reportNo}">${TbReportRecVO.reportTitle}</a></td>
