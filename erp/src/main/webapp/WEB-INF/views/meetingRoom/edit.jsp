...
<script src="/js/Fdelete.js"></script>
  <!-- chart js -->
...
<header id="header">
   ...
   <section class="container1">
       ...
       <form class="form" action="/res/editComplete" method="post">
	     <div class="input-box">
	         <label>예약자이름 </label>
	         <!-- 예약자 이름을 res.guestName으로 채워줍니다 -->
	         <input required="" name="guestName" placeholder="예약자 이름" type="text" value="${res.guestName}">
	     </div>
	     <label>회의실</label>
	     ...
	     <div class="input-box">
            ...
            <input required="" type="date" id="date-input" name="calDate" value="${res.calDate}">
        </div>
        <form action="editComplete" method="post">
            ...
            <input type="hidden" name="roomName" value="${res.roomName}" />
