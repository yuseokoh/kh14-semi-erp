	...
	<main id="body">
		...
		<section class="container1">
			...
			<form class="form" action="insert" method="post">
				<div class="input-box">
					<label>예약자이름 </label> <input required="" name="guestName"
						placeholder="예약자 이름" type="text">
				</div>

				<label>회의실 선택</label> <select class="select-box" id="room-select"
				...
				<div class="input-box">
					<label>날짜 </label> <input required="" type="date" id="date-input"
						name="calDate" placeholder="예약자 이름" type="text">
				</div>

				<div class="input-box">
					<label>시작시간</label> <select id="start-time-select" name="stime"
						required>
				...
				<div class="input-box">
					<label>종료 시간</label> <select id="end-time-select" name="etime"
						required>
				...
				<div class="input-box">
					<label>비밀번호(6자리 숫자)</label> <input type="password" name="pw"
						required>
				</div>
