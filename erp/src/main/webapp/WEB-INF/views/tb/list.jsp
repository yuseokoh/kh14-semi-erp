            ...
            <tbody class="tbody">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <tr class="row center">
                        	<td><img src="${pageContext.request.contextPath}/tb/myImage?loginId=${tbEmpDto.loginId}" width="25"></td>
                            <td>
                                <a href="${pageContext.request.contextPath}/tb/mypage?loginId=${tbEmpDto.loginId}">
                                    ${tbEmpDto.name}
                                </a>
                            </td>
