		...
		<nav id="menu">
			...
			<div class="row">
				<ul class="menu-hover-fill">
					<li><a href="#" data-text=""> <i class="fa-solid fa-house-user"></i> HOME
					</a></li>
					...
					<li><a href="#" data-text=""> <i class="fa-solid fa-cart-flatbed"></i> 재고관리
					</a>
						<ul>
					...
					<li><a href="#" data-text=""> <i class="fa-solid fa-id-card"></i> My Page
					</a>
						<ul>
					...
					<li><a href="#" data-text=""> <i class="fa-solid fa-comment"></i> 공지사항
					</a>
						<ul>
					...
					<li><a href="#" data-text=""> <i class="fa-solid fa-power-off"></i> 로그아웃
					</a></li>
				</ul>
			</div>
			</div>
